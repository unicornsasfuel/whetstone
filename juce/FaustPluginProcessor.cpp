/* ------------------------------------------------------------
author: "Evermind"
name: "whetstone", "Whetstone Transient Shaper"
...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "whetstone.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = (33.3333321f / fConst0);
		fConst3 = std::exp((0.0f - fConst2));
		fConst4 = (1.0f - fConst3);
		iConst5 = int(std::max<float>(0.0f, (0.0299999993f * fConst0)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Attack", &fHslider3, 0.0f, -12.0f, 12.0f, 0.100000001f);
		ui_interface->declare(&fHslider2, "1", "");
		ui_interface->declare(&fHslider2, "unit", "dB");
		ui_interface->addHorizontalSlider("Sustain", &fHslider2, 0.0f, -12.0f, 12.0f, 0.100000001f);
		ui_interface->declare(&fHslider1, "2", "");
		ui_interface->declare(&fHslider1, "unit", "Hz");
		ui_interface->addHorizontalSlider("Low Cutoff", &fHslider1, 10.0f, 10.0f, 20000.0f, 10.0f);
		ui_interface->declare(&fHslider0, "3", "");
		ui_interface->declare(&fHslider0, "unit", "Hz");
		ui_interface->addHorizontalSlider("High Cutoff", &fHslider0, 20000.0f, 20.0f, 20000.0f, 10.0f);
		...
		ui_interface->addVerticalBargraph("ON", &fVbargraph0, 0.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = std::tan((fConst1 * float(fHslider1)));
		float fSlow4 = (1.0f / fSlow3);
		float fSlow5 = (1.0f / (((fSlow4 + 1.0f) / fSlow3) + 1.0f));
		float fSlow6 = (1.0f - ((1.0f - fSlow4) / fSlow3));
		float fSlow7 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow3))));
		float fSlow8 = (1.0f - ((1.0f - fSlow1) / fSlow0));
		float fSlow9 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow0))));
		float fSlow10 = (fConst6 * std::pow(10.0f, (0.0500000007f * float(fHslider2))));
		float fSlow11 = (fConst6 * std::pow(10.0f, (0.0500000007f * float(fHslider3))));
		float fSlow12 = float(fButton0);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = float(input0[i0]);
			fRec4[0] = (fTemp0 - (fSlow5 * ((fSlow6 * fRec4[2]) + (fSlow7 * fRec4[1]))));
			float fTemp1 = (fSlow5 * (fRec4[2] + (fRec4[0] + (2.0f * fRec4[1]))));
			fRec3[0] = (fTemp0 - (fTemp1 + (fSlow2 * ((fSlow8 * fRec3[2]) + (fSlow9 * fRec3[1])))));
			float fTemp2 = (fRec3[2] + (fRec3[0] + (2.0f * fRec3[1])));
			fRec2[(IOTA & 8191)] = (fRec2[((IOTA - 1) & 8191)] + mydsp_faustpower2_f((fSlow2 * fTemp2)));
			float fTemp3 = std::sqrt((fConst2 * (fRec2[((IOTA - 0) & 8191)] - fRec2[((IOTA - iConst5) & 8191)])));
			fRec6[0] = ((fConst3 * fRec6[1]) + (fConst4 * fTemp3));
			float fRec5 = fRec6[0];
			fRec7[0] = (fSlow10 + (fConst7 * fRec7[1]));
			fRec8[0] = (fSlow11 + (fConst7 * fRec8[1]));
			fRec1[0] = ((fConst3 * fRec1[1]) + (fConst4 * (((fTemp3 - fRec5) > 0.0f) ? fRec8[0] : fRec7[0])));
			float fRec0 = fRec1[0];
			fVec0[0] = fSlow12;
			iRec9[0] = (iRec9[1] != ((fSlow12 - fVec0[1]) == 1.0f));
			fVbargraph0 = FAUSTFLOAT(iRec9[0]);
			int iTemp4 = (int(fVbargraph0) != 1);
			fRec10[0] = (fTemp0 - (fSlow2 * ((fSlow8 * fRec10[2]) + (fSlow9 * fRec10[1]))));
			output0[i0] = FAUSTFLOAT(((fSlow2 * (fRec0 * fTemp2)) + (iTemp4 ? ((fTemp0 + fTemp1) - (fSlow2 * (fRec10[2] + (fRec10[0] + (2.0f * fRec10[1]))))) : 0.0f)));
			float fTemp5 = float(input1[i0]);
			fRec15[0] = (fTemp5 - (fSlow5 * ((fSlow6 * fRec15[2]) + (fSlow7 * fRec15[1]))));
			float fTemp6 = (fSlow5 * (fRec15[2] + (fRec15[0] + (2.0f * fRec15[1]))));
			fRec14[0] = (fTemp5 - (fTemp6 + (fSlow2 * ((fSlow8 * fRec14[2]) + (fSlow9 * fRec14[1])))));
			float fTemp7 = (fRec14[2] + (fRec14[0] + (2.0f * fRec14[1])));
			fRec13[(IOTA & 8191)] = (fRec13[((IOTA - 1) & 8191)] + mydsp_faustpower2_f((fSlow2 * fTemp7)));
			float fTemp8 = std::sqrt((fConst2 * (fRec13[((IOTA - 0) & 8191)] - fRec13[((IOTA - iConst5) & 8191)])));
			fRec17[0] = ((fConst3 * fRec17[1]) + (fConst4 * fTemp8));
			float fRec16 = fRec17[0];
			fRec12[0] = ((fConst3 * fRec12[1]) + (fConst4 * (((fTemp8 - fRec16) > 0.0f) ? fRec8[0] : fRec7[0])));
			float fRec11 = fRec12[0];
			fRec18[0] = (fTemp5 - (fSlow2 * ((fSlow8 * fRec18[2]) + (fSlow9 * fRec18[1]))));
			output1[i0] = FAUSTFLOAT(((fSlow2 * (fRec11 * fTemp7)) + (iTemp4 ? ((fTemp5 + fTemp6) - (fSlow2 * (fRec18[2] + (fRec18[0] + (2.0f * fRec18[1]))))) : 0.0f)));
			fRec4[2] = fRec4[1];
			fRec4[1] = fRec4[0];
			fRec3[2] = fRec3[1];
			fRec3[1] = fRec3[0];
	...
	#define FAUST_FILE_NAME "whetstone.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Whetstone Transient Shaper/Attack", fHslider3, 0.0f, -12.0f, 12.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("Whetstone Transient Shaper/Sustain", fHslider2, 0.0f, -12.0f, 12.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("Whetstone Transient Shaper/Low Cutoff", fHslider1, 10.0f, 10.0f, 20000.0f, 10.0f);
	FAUST_ADDHORIZONTALSLIDER("Whetstone Transient Shaper/High Cutoff", fHslider0, 20000.0f, 20.0f, 20000.0f, 10.0f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Attack, "Whetstone Transient Shaper/Attack", fHslider3, 0.0f, -12.0f, 12.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, Sustain, "Whetstone Transient Shaper/Sustain", fHslider2, 0.0f, -12.0f, 12.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, Low_Cutoff, "Whetstone Transient Shaper/Low Cutoff", fHslider1, 10.0f, 10.0f, 20000.0f, 10.0f) \
		p(HORIZONTALSLIDER, High_Cutoff, "Whetstone Transient Shaper/High Cutoff", fHslider0, 20000.0f, 20.0f, 20000.0f, 10.0f) \
